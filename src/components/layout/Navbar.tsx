  ...
  const navItems = [
    { href: "/", label: "Accueil", icon: Home },
    {
      ...
      children: [
        ...
        { href: "/club/organigramme", label: "Staff", icon: Building },
            ...
            {navItems.map((item) => {
              ...
              return (
                <div key={item.label} className="relative group">
                  ...
                  {/* Sous-menu */}
                  <div
                    className={`xl:absolute xl:top-full xl:left-0 xl:bg-primary xl:shadow-lg xl:rounded-b-lg overflow-hidden transition-all duration-200
                      ${
                        openDropdown === item.label ||
                        pathname.startsWith(
                          item.children?.[0]?.href?.split("/")[1] ?? ""
                      ...
                      xl:group-hover:max-h-96 xl:group-hover:opacity-100 xl:group-hover:visible
                    xl:w-full`}
                  >
