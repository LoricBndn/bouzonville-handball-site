  ...
  return (
    <section className="relative bg-gradient-to-br from-light to-secondary/20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="bg-light rounded-lg shadow-xl overflow-hidden mb-12">
          <div className="relative h-[500px]">
            ...
            <div className="absolute inset-0 flex items-center">
              <div className="max-w-2xl m-4 sm:ml-8 text-light">
                <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 leading-tight font-title-xl">
                  Bouzonville Handball Club
                </h1>
                <h2 className="text-lg sm:text-xl md:text-2xl font-light mb-6 text-accent">
                  Passion, sport et convivialité depuis plus de 60 ans
                </h2>
                <p className="text-sm sm:text-base md:text-lg mb-8 text-light/80 leading-relaxed font-body">
                ...
                <div className="flex space-x-4">
                  <Link
                    href="/inscription"
                    className="bg-secondary hover:bg-orange-600 text-light px-6 sm:px-8 py-3 rounded-lg font-semibold transition-colors shadow-lg text-center"
                  >
                    Nous Rejoindre
                  </Link>
                  <Link
        ...
        {/* À propos */}
        <section className="max-w-7xl mx-auto py-12 sm:py-16 px-4 sm:px-6 lg:px-8 text-center border-b border-accent/20 bg-background mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-primary mb-4 font-title-lg">
        ...
        {/* Points forts */}
        <section className="max-w-7xl mx-auto py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-background mb-12">
          <h2 className="text-2xl sm:text-3xl font-bold text-primary text-center mb-12 font-title-lg">
            Nos Points Forts
          </h2>
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8 text-center">
            {[
              ...
              <div
                key={i}
                className="p-6 bg-primary/10 rounded-lg shadow hover:shadow-lg transition"
              >
                ...
                <p className="text-sm text-accent font-body">
                  ...
                  {title === "Infrastructures" &&
                    "Des infrastructures de qualité permettant le bon développement et la bonne formation de nos jeunes joueurs."}
                </p>
              </div>
            ))}
          </div>
        ...
        <div className="grid lg:grid-cols-3 gap-8 mb-12">
          ...
          <div className="bg-light rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-accent mb-4">
                Initiation au handball pour les jeunes de 6 à 12 ans dans une
                ambiance ludique et éducative.
              </p>
          ...
          <div className="bg-light rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-accent mb-4">
                Fitness inspiré du handball pour tous les âges. Cardio,
                renforcement musculaire et plaisir !
              </p>
              <div className="flex items-center justify-between">
          ...
          <div className="bg-light rounded-lg shadow-lg overflow-hidden hover:shadow-xl transition-shadow">
            ...
            <div className="p-6">
              ...
              <p className="text-accent mb-4">
                Formations d&apos;arbitrage du niveau départemental au niveau
                national. Rejoignez-nous !
              </p>
              <div className="flex items-center justify-between">
        ...
        <div className="mt-12 bg-gradient-to-r from-primary to-secondary rounded-lg shadow-xl p-8 text-center text-light">
          <h2 className="text-2xl sm:text-3xl font-bold mb-4 font-title-lg">
            Prêt à nous rejoindre ?
          </h2>
          <p className="text-lg sm:text-xl mb-6 text-light/80">
            Venez découvrir notre club lors d&apos;un entraînement ou
            contactez-nous pour plus d&apos;informations
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="tel:+33670833626"
              className="bg-light text-primary hover:bg-light/90 px-8 py-3 rounded-lg font-semibold transition-colors text-center"
            >
              📞 06 70 83 36 26
            </Link>
            <Link
