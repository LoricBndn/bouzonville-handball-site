  ...
  return (
    <div className="py-12 bg-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <PageHero
          title="Handfit"
          subtitle="Le handball fitness : une nouvelle façon de faire du sport, alliant plaisir, convivialité et efficacité"
          breadcrumbItems={[{ label: "Formation" }, { label: "Handfit" }]}
        />
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
          <div>
            ...
            <p className="text-gray-600 mb-4">
              Le Handfit est une activité physique inspirée du handball, adaptée
              à tous les niveaux et tous les âges. Cette discipline combine les
              gestes techniques du handball avec des exercices de fitness pour
              créer un entraînement complet et ludique.
            </p>
            <p className="text-gray-600 mb-4">
              Accessible à tous, le Handfit ne nécessite aucune expérience
              préalable du handball. Les séances sont conçues pour être
              progressives et s&apos;adapter au niveau de chaque participant.
            </p>
            <p className="text-gray-600 mb-6">
              Venez découvrir cette activité dans une ambiance détendue et
              conviviale, encadrée par nos coachs diplômés.
            </p>
            <div className="bg-orange-50 p-6 rounded-lg">
              <h3 className="font-bold text-orange-600 mb-2">
                🎯 Objectifs du Handfit
              </h3>
        ...
        <div className="grid lg:grid-cols-2 gap-12 mb-16">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">
                    Tenue de sport, chaussures de sport en salle, bouteille
                    d&apos;eau
                  </p>
                </div>
              </div>
              <div className="flex items-start space-x-3">
                ...
                <div>
                  ...
                  <p className="text-gray-600">100€ l&apos;abonnement annuel</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-orange-50 p-8 rounded-lg">
            ...
            <p className="text-gray-600 mb-6">
              Venez découvrir le Handfit lors d&apos;une séance d&apos;essai
              gratuite.
              <br />
              Pré-inscription préalable nécessaire, présentez-vous 15 minutes
